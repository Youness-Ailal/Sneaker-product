...
})({"2lJQV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "737e641923660007";
"use strict";
...
const mainImageProduct = document.querySelector(".product__main-image--container");
...
//Front Images
const secondImages = document.querySelectorAll(".product__second-image--container");
//Modal Images
...
document.addEventListener("click", (e)=>{
    if (!cart.contains(e.target) && e.target !== cartIcon && !addToCartBtn.contains(e.target) && !qtContainer.contains(e.target)) cart.classList.add("hidden");
});
...
document.addEventListener("click", (e)=>{
    if (imagesModel.contains(e.target) && !mainImageModel.contains(e.target) && !secondImagesModel.contains(e.target)) hideModal();
});
...
secondImages.forEach((el, index)=>{
    el.addEventListener("click", (e)=>{
        ...
        if (index + 1 === 1) src1 = (0, _imageProduct1JpgDefault.default);
        if (index + 1 === 2) src1 = (0, _imageProduct2JpgDefault.default);
        if (index + 1 === 3) src1 = (0, _imageProduct3JpgDefault.default);
        if (index + 1 === 4) src1 = (0, _imageProduct4JpgDefault.default);
...
nextBtn.addEventListener("click", ()=>{
    if (imageId !== 4) imageId++;
    else if (imageId === 4) imageId = 1;
    if (imageId === 1) src2 = (0, _imageProduct1JpgDefault.default);
    if (imageId === 2) src2 = (0, _imageProduct2JpgDefault.default);
    if (imageId === 3) src2 = (0, _imageProduct3JpgDefault.default);
    if (imageId === 4) src2 = (0, _imageProduct4JpgDefault.default);
    modelImage.style.opacity = "0";
    seconImagesModel.forEach((e)=>e.classList.remove("active-thumbnail"));
...
document.addEventListener("click", (e)=>{
    if (!navigation.contains(e.target) && !openNavBtn.contains(e.target) && !navigation.classList.contains("hiddenNav") || e.target.closest("li")?.contains(e.target)) {
        navigation.classList.add("hiddenNav");
        backgroundModel.classList.add("hidden-model-background");
    }
});
...
},{}],"im9Ir":[function(require,module,exports) {
module.exports = require("9e234f4a4b1f77e6").getBundleURL("9ULLa") + "image-product-1.5f963ded.jpg" + "?" + Date.now();

},{"9e234f4a4b1f77e6":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"KEseZ":[function(require,module,exports) {
module.exports = require("2d289b30cfd78246").getBundleURL("9ULLa") + "image-product-2.6c550b84.jpg" + "?" + Date.now();

},{"2d289b30cfd78246":"lgJ39"}],"jw4xS":[function(require,module,exports) {
module.exports = require("77257b0ba8ce6456").getBundleURL("9ULLa") + "image-product-3.ee366c07.jpg" + "?" + Date.now();

},{"77257b0ba8ce6456":"lgJ39"}],"g53pv":[function(require,module,exports) {
module.exports = require("824063721961162c").getBundleURL("9ULLa") + "image-product-4.20ac56af.jpg" + "?" + Date.now();

},{"824063721961162c":"lgJ39"}]},["2lJQV","fgDBQ"], "fgDBQ", "parcelRequire2f30")
